...
// Tell Excalidraw where to find its font/asset files.
// In dev, Vite serves node_modules directly so this isn't needed,
// but in the production Tauri bundle the fonts live under /excalidraw-assets/.
